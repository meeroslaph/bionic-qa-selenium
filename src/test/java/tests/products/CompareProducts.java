    ...
    public void compareProducts(int numberOfProducts) {
        ...
        for (int i = 0; i < numberOfProducts; i++) {
            ...
            */
            ...
            //Use this //*[contains(@class,'equal')]/td[1]
            String detailsTableColumn = "//*[contains(@class,'equal')]";
            List<WebElement> productsDetails = driver.findElements(By.xpath("//*[contains(@class,'equal')]"));
            HashMap<String, String> titleAndValue = new HashMap<String, String>();
            for (WebElement e : productsDetails) {
